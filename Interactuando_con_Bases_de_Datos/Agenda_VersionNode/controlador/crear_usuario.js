    ...
    Usuario.find({}, (err, usuarios) => {
      if (err) {
        ...
        if (usuarios.length <= 0) {
			...
			nuevoUsuario1.nombre = 'Jonathan'
			nuevoUsuario1.email = 'jonathan.canales@vab.cl'
			...
			nuevoUsuario2.nombre = 'Luis'
			nuevoUsuario2.email = 'luis@vab.cl'
			nuevoUsuario2.clave = 'luis2020'
