var Calculadora = {
	...
	, inicializarEfectoBoton : function(objNum) {
	...
	, inicializar : function(){
		...
		this.inicializarBotonNumero('0');
		this.inicializarBotonNumero('1');
		this.inicializarBotonNumero('2');
		this.inicializarBotonNumero('3');
		this.inicializarBotonNumero('4');
		this.inicializarBotonNumero('5');
		this.inicializarBotonNumero('6');
		this.inicializarBotonNumero('7');
		this.inicializarBotonNumero('8');
		this.inicializarBotonNumero('9');
		
		this.inicializarBotonOn();
		this.inicializarPunto();
		this.inicializarSign();
